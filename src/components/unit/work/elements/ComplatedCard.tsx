  ...
  return (
    ...
    >
      <div className="w-full">
        <div className="justify-center text-neutral-800 text-lg font-semibold mb-6">청구가 완료되었어요</div>
        <div className="self-stretch flex flex-col justify-start items-start gap-2">
          <div className="justify-start text-primary-normal text-base font-medium">청구 금액</div>
